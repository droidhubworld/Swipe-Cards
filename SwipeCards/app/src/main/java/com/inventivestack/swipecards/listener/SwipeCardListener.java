package com.inventivestack.swipecards.listener;
...
import com.inventivestack.swipecards.MainActivity;
import com.inventivestack.swipecards.widget.LinearRegression;
...
public class SwipeCardListener implements View.OnTouchListener {
    ...
    public SwipeCardListener(View frame, Object itemAtPosition, CardListener mCardListener) {
        this(frame, itemAtPosition, 15f, mCardListener);

    }

    public SwipeCardListener(View frame, Object itemAtPosition, float rotation_degrees, CardListener mCardListener) {
        super();
    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mCardListener.onScroll(getScrollProgressPercent());
                break;
    ...
    private boolean resetCardViewOnStack() {
        if (movedBeyondLeftBorder()) {
            ...
            frame.animate()
                    ...
                    .y(objectY)
                    .rotation(0);
            mCardListener.onScroll(0.0f);
            if (abslMoveDistance < 4.0) {
                mCardListener.onClick(dataObject);
            }
        }
        return false;
    }
        ...
        this.frame.animate()
                ...
                .setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        if (isLeft) {
                            mCardListener.onCardExited();
                            mCardListener.leftExit(dataObject);
                        } else {
                            mCardListener.onCardExited();
                            mCardListener.rightExit(dataObject);
                        }
